    ...
    <div class="max-w-4xl mx-auto mt-10 bg-white p-8 shadow-lg rounded-lg">
        ...
        @else
            <ul>
                @foreach ($appointments as $appointment)
                    ...
                    @endphp
                    <li
                        class="border-b py-6 px-4 flex justify-between items-center
                    {{ $isPast ? 'bg-gray-100 text-gray-500' : 'bg-white shadow-md' }} rounded-lg mb-4">
                        ...
                        <div class="w-3/4">
                            ...
                            <p class="text-sm text-gray-600">
                                {{ \Carbon\Carbon::parse($appointment->appointment_time)->format('d M Y H:i') }}</p>
        ...
        <div class="mt-4 text-center">
            <a href="{{ route('appointments.export') }}"
                class="bg-yellow-600 hover:bg-yellow-700 text-white py-2 px-6 rounded-full shadow-md transition duration-200">
